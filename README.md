...
To build the final jar and optimize the apiApplication application for production, run:
...
Then navigate to [http://localhost:85871](http://localhost:85871) in your browser.
