...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, ru.publicapi.site.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, ru.publicapi.site.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, ru.publicapi.site.domain.User.class.getName());
            createCache(cm, ru.publicapi.site.domain.Authority.class.getName());
            ...
            createCache(cm, ru.publicapi.site.domain.ApiKey.class.getName());
