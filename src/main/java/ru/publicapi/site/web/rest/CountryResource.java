...
/**
 * REST controller for managing {@link ru.publicapi.site.domain.Country}.
 */
@RestController
        ...
        Optional<Country> result = countryRepository
            ...
            .map(existingCountry -> {
                ...
                if (country.getValue() != null) {
                    existingCountry.setValue(country.getValue());
                }
                if (country.getNameShort() != null) {
                    existingCountry.setNameShort(country.getNameShort());
                }
                ...
                if (country.getAlfa2Country() != null) {
                    existingCountry.setAlfa2Country(country.getAlfa2Country());
                }
                if (country.getAlfa3Country() != null) {
                    existingCountry.setAlfa3Country(country.getAlfa3Country());
                }
                if (country.getIsActual() != null) {
                    existingCountry.setIsActual(country.getIsActual());
                }
