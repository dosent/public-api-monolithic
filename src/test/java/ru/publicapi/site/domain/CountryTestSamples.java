...
public class CountryTestSamples {
    ...
    public static Country getCountrySample1() {
        return new Country()
            ...
            .nameFull("nameFull1")
            .nameShortEng("nameShortEng1")
            .nameFullEng("nameFullEng1")
    ...
    public static Country getCountrySample2() {
        return new Country()
            ...
            .nameFull("nameFull2")
            .nameShortEng("nameShortEng2")
            .nameFullEng("nameFullEng2")
    ...
    public static Country getCountryRandomSampleGenerator() {
        return new Country()
            ...
            .nameShortEng(UUID.randomUUID().toString())
            .nameFullEng(UUID.randomUUID().toString())
